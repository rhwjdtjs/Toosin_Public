...
- **적응형 난이도**: `ATSEnemyController`가 플레이어의 공격 빈도와 방어 스타일을 실시간으로 분석하여 대응 패턴을 진화시킵니다.

### 🎲 로그라이크 성장 & 허브 (Roguelike & Hub)
- **무한한 성장 가능성**: 매 라운드 종료 후 무작위 특성을 선택하고, 허브에서 무기를 교체하거나 샌드백을 통해 콤보를 연구할 수 있습니다.

### 🏆 글로벌 랭킹 & 경쟁 (Global Ranking)
- **Stove & Steam Leaderboards**: 각 플랫폼 SDK를 통해 실시간 글로벌 랭킹을 산출하고 다른 플레이어와 경쟁할 수 있습니다.
...
- **개발팀**: TEAM NIRIZ (TEAM NIRIZ development team)
- **공식 디스코드**: [소통 및 피드백 디스코드 서버](https://discord.gg/3R9kHMtEg6)
